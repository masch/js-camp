    ...
    return (
        <main>
            <section>
                ...
                <p>Únete a la comunidad más grande de desarrolladores y encuentra tu proxima oportunidad.</p>
            ...
            <section>
                <header>
                    ...
                    <p>Devjobs es la principal plataform búsqueda de empleo para desarrolladores. Contactmos a los mejores
                        talentos con empresas más innovadoras</p>
                </header>

                <footer>
                    <article>
                        <svg fill="currentColor" height="32" viewBox="0 0 256 256" width="32" aria-hidden="true">
                            <path
